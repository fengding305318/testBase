...
public class OnlineFaceDemo extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.wfc_pick).setOnClickListener(OnlineFaceDemo.this);
		findViewById(R.id.wfc_reg).setOnClickListener(OnlineFaceDemo.this);
		findViewById(R.id.wfc_verify).setOnClickListener(OnlineFaceDemo.this);
		findViewById(R.id.wfc_camera).setOnClickListener(OnlineFaceDemo.this);
		findViewById(R.id.wfc_detect).setOnClickListener(OnlineFaceDemo.this);
		findViewById(R.id.wfc_align).setOnClickListener(OnlineFaceDemo.this);
