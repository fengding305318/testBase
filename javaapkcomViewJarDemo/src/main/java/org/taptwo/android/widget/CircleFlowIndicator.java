...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	//这个是点的颜色
	private int activeDefaultColor = Color.RED;
	
	//这是圆圈的颜色
	private int inactiveDefaultColor = Color.GREEN;
	
	//设置圆的直径
	private float activeNum = 10.0f;
	
	//设置圆的间距
	private float inactiveNum = 10.0f;
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		// Retrieve the radius
		mRadius = a.getDimension(R.styleable.CircleFlowIndicator_radius, activeNum);
		mRadiusActive = mRadius;
		mRadiusInactive = mRadius;

		// Retrieve the spacing
		spacing = a.getDimension(R.styleable.CircleFlowIndicator_spacing, inactiveNum);
