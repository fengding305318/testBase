package com.sanping.notifyanim;
 ...
 * 在布局上应用了一个style
 */
public class NotifyAnimActivity extends Activity{
	private Effects effect;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		setContentView(R.layout.activity_notify_anim);
		super.onCreate(savedInstanceState);
	}
	
	//这个方法是在style中定义的button点击时运行的方法
	public void dialogShow(View v){
        ...
        NiftyNotificationView.build(this,msg, effect,R.id.mLayout)
        .setIcon(R.drawable.composer_sun)         //You must call this method if you use ThumbSlider effect
        .show();
